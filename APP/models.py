...
class family(models.Model):
    ...
    cow_names = models.ForeignKey(
        cow, null=True, blank=True, related_name="cow_names", on_delete=models.CASCADE
    )
    sheaps = models.IntegerField(null=True, blank=True)
    sheap_names = models.ForeignKey(
        sheap,
        null=True,
        blank=True,
    ...
    goat_names = models.ForeignKey(
        goat, null=True, blank=True, related_name="goat_names", on_delete=models.CASCADE
    )
